...
def test_cpp_complete_intrinsic_positive_cases_are_accepted(case, driver, tmp_path):
    _, arch, program = case
...
def test_cpp_complete_intrinsic_cases_have_exact_diagnostics(case, driver, tmp_path):
